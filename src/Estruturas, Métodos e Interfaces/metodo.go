// O que é? -> Método é uma função associada a um tipo particular.
// Isto é, em POO(Prog. Orientada a Objeto), objeto é um valor(variável) e o método é uma função associada a esse objeto
